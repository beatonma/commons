...
import org.beatonma.commons.app.data.parse.Geometry
import org.beatonma.commons.app.data.parse.KmlParser
...
private fun Geometry.setStyle(colors: PartyColors, config: MapConfig) =
    setStyle(

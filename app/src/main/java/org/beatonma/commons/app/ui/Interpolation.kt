...
object Interpolation {
    val motion: Interpolator = FastOutSlowInInterpolator

    /**
     * Interpolator used for introducing an object from offscreen
     */
    val enter: Interpolator = LinearOutSlowInInterpolator

    /**
     * Interpolator used for removing an object from the screen
     */
    val exit: Interpolator = FastOutLinearInInterpolator
}



/*
 * Following definitions are from AOSP and are subject to its license as follows:
 *
...
private object LinearOutSlowInInterpolator: LookupTableInterpolator(
    values = floatArrayOf(
...
private object FastOutLinearInInterpolator: LookupTableInterpolator(
    values = floatArrayOf(
 ...
 * Cloned from [androidx.interpolator.view.animation]
 *
 ...
 * P3 (1.0, 1.0)
 */
private object FastOutSlowInInterpolator : LookupTableInterpolator(
    /**
 ...
 * Cloned from [androidx.interpolator.view.animation]
 */
private abstract class LookupTableInterpolator(

...
//        PARTY_ALLIANCE_PARLIAMENTDOTUK -> context.getString(R.string.party_alliance)
        ...
        PARTY_CONSERVATIVE_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_conservative)
        PARTY_DEMOCRATIC_UNIONIST_PARTY_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_dup)
        PARTY_GREEN_PARTY_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_green)
        PARTY_LABOUR_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_labour)
        PARTY_LABOUR_COOP_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_labour_coop)
        PARTY_LIBERAL_DEMOCRAT_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_lib_dem)
        PARTY_PLAID_CYMRU_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_plaid_cymru)
//        PARTY_RESPECT_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_respect)
        PARTY_SOCIAL_DEMOCRATIC_LABOUR_PARTY_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_sdlp)
//        PARTY_SOCIAL_DEMOCRATIC_PARTY_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_sdp)
        PARTY_SINN_FEIN_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_sinn_fein)
        PARTY_SCOTTISH_NATIONAL_PARTY_PARLIAMENTDOTUK -> context.stringCompat(R.string.party_snp)
